...
INTRO_SECTION_3_PM25 = ["""PM2.5""", 
"""
    * Fine particles under 2.5µm,
    * Primary fire smoke tracer
    * Penetrate deep into the lungs, enter the bloodstream, and travel to organs causing systemic damages to tissues and cells
"""]

INTRO_SECTION_3_PM10 = ["""PM10""", 
"""
    * Coarse particles between 2.5 µm and 10 µm
    * Generated by a wider range of sources than PM2.5 (road dust, construction…)
    * Less precise for fire attribution but  relevant for respiratory exposure.
"""]

INTRO_SECTION_3_O3 = ["""Ground-level Ozone (O3)""", 
"""
    * Formed through photochemical reactions between sunlight, volatile organic compounds, carbon monoxide and nitrogen oxides from vehicles.
    * Major component of smog and highest levels of ozone in summer
    * Exposure to excessive levels can cause respiratory issues.
"""]

INTRO_SECTION_3_NO2 = ["""Nitrogen Dioxide (NO2)""", 
"""
    * Produced by high high temperature combustion of fuels (heating, transportation, industry…)
    * Important ozone precursor,
"""]

INTRO_SECTION_3_CO = ["""Carbon Monoxide (CO)""", 
"""
    * Produced by the incomplete combustion of carbonaceous fuels such as wood, petrol, coal…
    * Predominant source in ambient air is motor vehicles
"""]

INTRO_SECTION_3_SO2 = ["""Sulfur Dioxide (SO2)""", 
"""
    * Derived from combustion of fossil fuels (heating, industries and power generation)
